<?php
// source: /opt/lampp/htdocs/nette/app/config/config.neon 
// source: /opt/lampp/htdocs/nette/app/config/config.local.neon 

class Container_2610061130 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\MainPagePresenter' => [1 => ['application.3']],
		...
		'services' => [
			...
			'application.3' => 'App\Presenters\MainPagePresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => '/opt/lampp/htdocs/nette/app',
			'wwwDir' => '/opt/lampp/htdocs/nette/www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => '/opt/lampp/htdocs/nette/app/../temp',
		];
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/opt/lampp/htdocs/nette/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('/opt/lampp/htdocs/nette/app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/opt/lampp/htdocs/nette/app/../temp/cache',
	...
	{
		return new Container_2610061130_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_2610061130_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_2610061130 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('/opt/lampp/htdocs/nette/app/../temp/cache/latte');
