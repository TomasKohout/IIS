...
class Container_9a059b4dab extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'Instante\ExtendedFormMacros\Latte\FormRenderingDispatcher' => [1 => ['extendedFormmMacros.formRenderingDispatcher']],
			...
			'Instante\ExtendedFormMacros\IFormFactory' => [1 => ['formFactory']],
			'Instante\Bootstrap3Renderer\BootstrapFormFactory' => [1 => ['formFactory']],
			...
			'App\Presenters\AddAnimalPresenter' => [1 => ['application.2']],
			'App\Presenters\BasePresenter' => [1 => ['application.3', 'application.8']],
			'App\Presenters\SignPresenter' => [1 => ['application.3']],
			'App\Presenters\MainPagePresenter' => [1 => ['application.4']],
			'App\Presenters\DeleteAnimalPresenter' => [1 => ['application.5']],
			'App\Presenters\ErrorPresenter' => [1 => ['application.6']],
			'App\Presenters\UpdateAnimalPresenter' => [1 => ['application.7']],
		...
		'services' => [
			...
			'application.2' => 'App\Presenters\AddAnimalPresenter',
			'application.3' => 'App\Presenters\SignPresenter',
			'application.4' => 'App\Presenters\MainPagePresenter',
			'application.5' => 'App\Presenters\DeleteAnimalPresenter',
			'application.6' => 'App\Presenters\ErrorPresenter',
			'application.7' => 'App\Presenters\UpdateAnimalPresenter',
			...
			'extendedFormmMacros.formRenderingDispatcher' => 'Instante\ExtendedFormMacros\Latte\FormRenderingDispatcher',
	...
	public function createServiceApplication__1()
	{
		...
		$service->formFactory = $this->getService('formFactory');
	...
	/**
	 * @return App\Presenters\AddAnimalPresenter
	 */
	public function createServiceApplication__2()
	{
		$service = new App\Presenters\AddAnimalPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	/**
	 * @return App\Presenters\MainPagePresenter
	 */
	...
	/**
	 * @return App\Presenters\DeleteAnimalPresenter
	 */
	public function createServiceApplication__5()
	{
		$service = new App\Presenters\DeleteAnimalPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	/**
	 * @return App\Presenters\UpdateAnimalPresenter
	 */
	public function createServiceApplication__7()
	{
		$service = new App\Presenters\UpdateAnimalPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('/opt/lampp/htdocs/IIS/app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/opt/lampp/htdocs/IIS/app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=IIS', 'root',
			null, ['lazy' => true]);
	...
	/**
	 * @return Instante\ExtendedFormMacros\Latte\FormRenderingDispatcher
	 */
	public function createServiceExtendedFormmMacros__formRenderingDispatcher()
	{
		$service = new Instante\ExtendedFormMacros\Latte\FormRenderingDispatcher;
		return $service;
	}


	/**
	 * @return Instante\Bootstrap3Renderer\BootstrapFormFactory
	 */
	public function createServiceFormFactory()
	{
		$service = new Instante\Bootstrap3Renderer\BootstrapFormFactory;
		return $service;
	}
	...
	{
		return new Container_9a059b4dab_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_9a059b4dab_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_9a059b4dab $container)
	{
	...
	public function create()
	{
		...
		$service->onCompile[] = function() use ($service) { Instante\ExtendedFormMacros\Latte\FormMacros::install($service->getCompiler()); };
		$service->addProvider('formRenderingDispatcher', $this->container->getService('extendedFormmMacros.formRenderingDispatcher'));
		return $service;
	}
}
